...
HD_PWD='C:/Users/Vikram/Downloads/simd_division_zynq/simd_division_zynq/simd_division_zynq.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log simd_division_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source simd_division_wrapper.tcl
