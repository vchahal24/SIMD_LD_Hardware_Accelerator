...
HD_PWD='C:/Users/Vikram/Downloads/simd_division_zynq/simd_division_zynq/simd_division_zynq.runs/simd_division_my_simd_divider_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log simd_division_my_simd_divider_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source simd_division_my_simd_divider_0_0.tcl
