...
HD_PWD='C:/Users/Vikram/Downloads/simd_division_zynq/simd_division_zynq/simd_division_zynq.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log simd_division_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source simd_division_wrapper.tcl -notrace
