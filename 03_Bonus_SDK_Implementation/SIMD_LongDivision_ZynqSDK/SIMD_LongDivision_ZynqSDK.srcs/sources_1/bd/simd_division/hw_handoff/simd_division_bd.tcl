...
################################################################
# This is a generated script based on design: simd_division
#
...
# source simd_division_script.tcl
...
CONFIG.NUM_MI {1} \
  ...
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M00_AXI [get_bd_intf_pins my_simd_divider_0/S00_AXI] [get_bd_intf_pins ps7_0_axi_periph/M00_AXI]

  # Create port connections
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins my_simd_divider_0/s00_axi_aclk] [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins ps7_0_axi_periph/ACLK] [get_bd_pins ps7_0_axi_periph/M00_ACLK] [get_bd_pins ps7_0_axi_periph/S00_ACLK] [get_bd_pins rst_ps7_0_50M/slowest_sync_clk]
  connect_bd_net -net processing_system7_0_FCLK_RESET0_N [get_bd_pins processing_system7_0/FCLK_RESET0_N] [get_bd_pins rst_ps7_0_50M/ext_reset_in]
  connect_bd_net -net rst_ps7_0_50M_interconnect_aresetn [get_bd_pins ps7_0_axi_periph/ARESETN] [get_bd_pins rst_ps7_0_50M/interconnect_aresetn]
  connect_bd_net -net rst_ps7_0_50M_peripheral_aresetn [get_bd_pins my_simd_divider_0/s00_axi_aresetn] [get_bd_pins ps7_0_axi_periph/M00_ARESETN] [get_bd_pins ps7_0_axi_periph/S00_ARESETN] [get_bd_pins rst_ps7_0_50M/peripheral_aresetn]

  # Create address segments
  create_bd_addr_seg -range 0x00010000 -offset 0x43C00000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs my_simd_divider_0/S00_AXI/S00_AXI_reg] SEG_my_simd_divider_0_S00_AXI_reg
...
preplace inst rst_ps7_0_50M -pg 1 -lvl 2 -y -110 -defaultsOSRD
preplace inst ps7_0_axi_periph -pg 1 -lvl 3 -y -150 -defaultsOSRD
preplace inst my_simd_divider_0 -pg 1 -lvl 2 -y -350 -defaultsOSRD
preplace inst processing_system7_0 -pg 1 -lvl 1 -y -210 -defaultsOSRD
preplace netloc processing_system7_0_DDR 1 1 3 390J -280 740J -290 NJ
preplace netloc processing_system7_0_M_AXI_GP0 1 1 2 NJ -230 740
preplace netloc processing_system7_0_FCLK_RESET0_N 1 1 1 N
preplace netloc rst_ps7_0_50M_interconnect_aresetn 1 2 1 750
preplace netloc processing_system7_0_FIXED_IO 1 1 3 NJ -270 NJ -270 NJ
preplace netloc rst_ps7_0_50M_peripheral_aresetn 1 1 2 410 -20 760
preplace netloc processing_system7_0_FCLK_CLK0 1 0 3 10 -340 400 -200 740
preplace netloc ps7_0_axi_periph_M00_AXI 1 1 3 410 -420 NJ -420 1020
levelinfo -pg 1 -10 200 580 890 1040 -top -450 -bot 170
",
}
